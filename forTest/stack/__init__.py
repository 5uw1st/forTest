...
class Stack(object):
    ...
    def __init__(self, stack, length=10):
        self._length = length
        self._top = -1
        self._stack = stack
...
class StackByArray(Stack):
    ...
    def __init__(self, length=10):
        super(StackByArray, self).__init__(length=length, stack=Array())
...
class StackByLinkedList(Stack):
    ...
    def __init__(self, length=10):
        super(StackByLinkedList, self).__init__(length=length, stack=LinkList())
